...
function changeGit() {
    $('#changeGit').attr("src", "images/Icons/Circle_Color/Github.png")
}
function changeGitBack() {
    $('#changeGit').attr("src", "images/Icons/Circle_Black_White/Github.png")
}
//Changes the LinkedIn Button
function changeLinkedin() {
    $('#changeLinkedin').attr("src", "images/Icons/Circle_Color/Linkedin.png")
}
function changeLinkBack() {
    $('#changeLinkedin').attr("src", "images/Linkedin.png")
}
//Changes the Facebook Logo
function changeFace() {
    $('#facebook').attr("src", "images/Icons/Circle_Color/Facebook.png")
}
function changeFaceBack() {
    $('#facebook').attr("src", "images/Icons/Circle_Black_White/Facebook.png")
}
//Changes the BitBucket 
function changeBit() {
    $('#bucket').attr("src", "images/Icons/Circle_Color/bitBucket.png")
}
function changeBitBack() {
    $('#bucket').attr("src", "images/Icons/Circle_Black_White/bitBucket.png")
}
